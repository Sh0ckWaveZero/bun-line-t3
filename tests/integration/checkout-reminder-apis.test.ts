...
describe('Checkout Reminder APIs Comparison', () => {
  it('should have consistent logic between standard and enhanced APIs', async () => {
    ...
    const enhancedAPI = await import('@/app/api/cron/enhanced-checkout-reminder/route')
  ...
  it('should use same reminder timing logic', async () => {
    const { shouldReceiveReminderNow, calculateUserReminderTime } = await import('@/features/attendance/services/attendance')
