...
import { calculateUserReminderTime, shouldReceiveReminderNow } from '../../../src/features/attendance/helpers/utils';
...
describe('Enhanced Checkout Reminder Tests', () => {
  ...
  describe('shouldReceiveReminderNow', () => {
    test('should return true when current time matches reminder time', () => {
      ...
      const shouldRemind = shouldReceiveReminderNow(checkInTimeUTC, currentTimeBangkok);
    ...
    test('should return true when current time is within tolerance', () => {
      ...
      const shouldRemind = shouldReceiveReminderNow(checkInTimeUTC, currentTimeBangkok, 5);
  ...
  describe('Real World Scenarios', () => {
    test('should handle the exact scenario from the bug report', () => {
      ...
      const shouldRemind = shouldReceiveReminderNow(checkInTimeUTC, currentTime);
    ...
    test('should calculate working hours correctly', () => {
      ...
      const workingHours = (checkOutTimeUTC.getTime() - checkInTimeUTC.getTime()) / (1000 * 60 * 60);
