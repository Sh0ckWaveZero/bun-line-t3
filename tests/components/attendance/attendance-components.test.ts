...
describe('🧩 Attendance Components', () => {
  ...
  describe('🔒 Security Tests', () => {
    ...
    it('should validate attendance status types', () => {
      const validStatuses = ['CHECKED_IN_ON_TIME', 'CHECKED_IN_LATE', 'CHECKED_OUT', 'AUTO_CHECKOUT_MIDNIGHT'];
...
describe('🔧 Utility Functions', () => {
  ...
  it('should calculate time differences', () => {
    ...
    const hours = calculateHours('2025-06-12T09:00:00Z', '2025-06-12T18:00:00Z');
    expect(hours).toBe(9);
  });
});
