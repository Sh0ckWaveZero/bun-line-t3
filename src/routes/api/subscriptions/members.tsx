...
export async function POST(request: Request) {
  try {
    ...
    if (error instanceof Error) {
      console.error(
        "[POST /api/subscriptions/members] Error message:",
        error.message,
      );
      console.error(
        "[POST /api/subscriptions/members] Error stack:",
        error.stack,
      );
    }
    if (error instanceof z.ZodError) {
      console.error(
        "[POST /api/subscriptions/members] ZodError:",
        error.issues,
      );
    }
    return createErrorResponse(error);
