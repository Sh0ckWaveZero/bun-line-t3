...
function Home() {
  ...
  return (
    <main
      id="page-home"
      className="relative flex min-h-screen flex-col items-center justify-center bg-linear-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-indigo-900 dark:to-purple-900"
    >
      <div
        id="container-main"
          ...
          <>
            ...
            >
              <div id="profile-image-wrapper" className="relative">
                <div className="absolute -inset-2 rounded-full bg-linear-to-r from-blue-500 via-purple-500 to-pink-500 opacity-75 blur-lg"></div>
                <img
                  id="profile-image"
