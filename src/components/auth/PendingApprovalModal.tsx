  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="bg-card animate-in fade-in zoom-in relative w-full max-w-md rounded-xl border p-8 text-center shadow-2xl duration-200"
      >
        {/* Icon */}
        <div
          id="approval-modal-icon"
        ...
        <div id="approval-modal-actions" className="flex flex-col gap-3">
          ...
          <a
            ...
            href="/logout"
            className="text-muted-foreground hover:bg-accent hover:text-accent-foreground inline-flex w-full items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-colors"
          >
            ออกจากระบบ
          </a>
        </div>
