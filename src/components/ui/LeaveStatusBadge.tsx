    ...
    <>
      ...
      <div className="hidden sm:block">
        <Tooltip.Provider>
          <Tooltip.Root>
            ...
            <Tooltip.Portal>
              <Tooltip.Content
                className="z-50 max-w-xs rounded-lg bg-gray-900 px-3 py-2 text-sm text-white shadow-lg dark:bg-gray-800 dark:text-gray-200"
                sideOffset={5}
                align="center"
              >
      ...
      <div className="block sm:hidden">
        ...
        >
          ...
          <Popover.Portal>
            <Popover.Content
              className="animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 z-50 max-w-xs rounded-lg bg-gray-900 px-3 py-2 text-sm text-white shadow-lg dark:bg-gray-800 dark:text-gray-200"
              sideOffset={5}
              align="center"
