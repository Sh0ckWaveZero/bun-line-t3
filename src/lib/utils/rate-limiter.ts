...
export class RateLimiter {
   ...
   */
  static async checkCronRateLimit(request: NextRequest): Promise<NextResponse | null> {
    try {
...
export function withRateLimit(
  ...
  return async (request: NextRequest): Promise<NextResponse> => {
    ...
    return RateLimiter.addRateLimitHeaders(response, result.remainingRequests, result.resetTime)
  }
}
