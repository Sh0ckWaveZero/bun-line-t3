...
export const dateFormatters = {
  ...
  fullDate: (dateString: string) => formatDateSafe(dateString, {
    year: 'numeric',
    month: 'long',
    day: 'numeric',
    weekday: 'long'
  ...
  shortDate: (dateString: string) => formatDateSafe(dateString, {
    year: 'numeric',
    month: '2-digit',
    day: '2-digit'
  }),
  ...
  time24: (dateString: string) => formatTimeSafe(dateString, {
    hour: '2-digit',
    minute: '2-digit',
    hour12: false
  }),
  ...
  time12: (dateString: string) => formatTimeSafe(dateString, {
    hour: '2-digit',
    minute: '2-digit',
    hour12: true
  }),
  ...
  monthYear: (dateString: string) => formatDateSafe(dateString, {
    year: 'numeric',
    month: 'long'
  }),

  // วันในสัปดาห์ เช่น "วันจันทร์"
  weekday: (dateString: string) => formatDateSafe(dateString, {
    weekday: 'long'
  })
} as const;
