...
const EMOJI_OPTIONS: EmojiOption[] = [
  {
    emoji: "🍔",
    label: "อาหาร",
    keywords: "food meal burger eat restaurant อาหาร กิน ร้านอาหาร",
  },
  {
    emoji: "🍜",
    label: "ก๋วยเตี๋ยว",
    keywords: "noodle ramen food อาหาร ก๋วยเตี๋ยว",
  },
  {
    emoji: "🍱",
    label: "ข้าวกล่อง",
    keywords: "bento lunch food อาหาร กลางวัน",
  },
  {
    emoji: "☕",
    label: "กาแฟ",
    keywords: "coffee drink cafe กาแฟ เครื่องดื่ม คาเฟ่",
  },
  { emoji: "🍺", label: "เครื่องดื่ม", keywords: "beer drink bar เครื่องดื่ม" },
  {
    emoji: "🛒",
    label: "ของใช้",
    keywords: "grocery shopping market ของใช้ ตลาด ซื้อของ",
  },
  {
    emoji: "🛍️",
    label: "ช้อปปิ้ง",
    keywords: "shopping bag buy mall ช้อปปิ้ง ซื้อของ",
  },
  {
    emoji: "👕",
    label: "เสื้อผ้า",
    keywords: "shirt clothes fashion เสื้อผ้า แฟชั่น",
  },
  { emoji: "👟", label: "รองเท้า", keywords: "shoes sneaker รองเท้า" },
  {
    emoji: "💄",
    label: "ความงาม",
    keywords: "beauty makeup cosmetic ความงาม เครื่องสำอาง",
  },
  ...
  { emoji: "🚌", label: "รถเมล์", keywords: "bus transport รถเมล์ เดินทาง" },
  {
    emoji: "🚕",
    label: "แท็กซี่",
    keywords: "taxi ride transport แท็กซี่ เดินทาง",
  },
  {
    emoji: "✈️",
    label: "เดินทาง",
    keywords: "flight plane travel trip เที่ยว เดินทาง",
  },
  {
    emoji: "🏠",
    label: "บ้าน",
    keywords: "home house rent บ้าน ที่พัก ค่าเช่า",
  },
  { emoji: "🏢", label: "คอนโด", keywords: "condo apartment rent คอนโด หอพัก" },
  {
    emoji: "💡",
    label: "ไฟฟ้า",
    keywords: "electric utility bill ไฟฟ้า ค่าน้ำ ค่าไฟ",
  },
  { emoji: "💧", label: "ค่าน้ำ", keywords: "water utility bill น้ำ ค่าน้ำ" },
  {
    emoji: "📶",
    label: "อินเทอร์เน็ต",
    keywords: "internet wifi phone อินเทอร์เน็ต โทรศัพท์",
  },
  { emoji: "📱", label: "มือถือ", keywords: "phone mobile มือถือ โทรศัพท์" },
  {
    emoji: "🏥",
    label: "สุขภาพ",
    keywords: "health hospital medical สุขภาพ โรงพยาบาล",
  },
  ...
  { emoji: "🦷", label: "ฟัน", keywords: "dental tooth dentist ฟัน หมอฟัน" },
  {
    emoji: "🏋️",
    label: "ฟิตเนส",
    keywords: "fitness gym exercise ฟิตเนส ออกกำลัง",
  },
  ...
  { emoji: "🎵", label: "เพลง", keywords: "music song เพลง subscription" },
  {
    emoji: "📚",
    label: "การศึกษา",
    keywords: "book education study เรียน หนังสือ การศึกษา",
  },
  ...
  { emoji: "🏦", label: "ธนาคาร", keywords: "bank finance ธนาคาร การเงิน" },
  {
    emoji: "📈",
    label: "ลงทุน",
    keywords: "invest stock profit ลงทุน หุ้น กำไร",
  },
  {
    emoji: "🎁",
    label: "ของขวัญ",
    keywords: "gift bonus present ของขวัญ โบนัส",
  },
  ...
  { emoji: "🧾", label: "บิล", keywords: "bill receipt invoice บิล ใบเสร็จ" },
  {
    emoji: "💸",
    label: "รายจ่าย",
    keywords: "expense spending money รายจ่าย ใช้เงิน",
  },
  ...
  { emoji: "🌱", label: "ต้นไม้", keywords: "plant garden ต้นไม้ สวน" },
  {
    emoji: "🧹",
    label: "ทำความสะอาด",
    keywords: "clean home ทำความสะอาด บ้าน",
  },
  {
    emoji: "🔧",
    label: "ซ่อม",
    keywords: "repair tool maintenance ซ่อม เครื่องมือ",
  },
  ...
  { emoji: "👶", label: "ลูก", keywords: "baby child kid ลูก เด็ก" },
  {
    emoji: "🙏",
    label: "ทำบุญ",
    keywords: "donate merit charity ทำบุญ บริจาค",
  },
...
export function EmojiPickerModal({
  ...
  const filteredEmojis = useMemo(() => {
    ...
    return EMOJI_OPTIONS.filter((item) =>
      `${item.emoji} ${item.label} ${item.keywords}`
        .toLowerCase()
...
function EmojiButton({ emoji, label, onClick }: EmojiButtonProps) {
  return (
    <button
      ...
      className="hover:bg-muted focus-visible:ring-ring flex aspect-square items-center justify-center rounded-lg text-2xl transition-colors focus-visible:ring-2 focus-visible:outline-none"
    >
      {emoji}
    </button>
  );
